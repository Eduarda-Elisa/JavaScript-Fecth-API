...
const weatherAPIKey = "dc37b18e83f537f7685e06432a8ad23e"
...
function weatherHandler() {
    ...
    navigator.geolocation.getCurrentPosition(position => {
        ...
        let url = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=${weatherAPIKey}&units=metric`
        fetch(url)
